...
//  dampedOscilator
//
//  Created by Hadi Mohammadi on 11/23/16.
//  Copyright © 2016 Hadi Mohammadi. All rights reserved.
//
...
struct Fitmrq {
    static const Int NDONE=4, ITMAX=1000;  //Convergence parameter
    Int ndat, ma, mfit;
    VecDoub_I &x,&y,&sig;
    Doub tol;
    ...
    Fitmrq(VecDoub_I &xx, VecDoub_I &yy, VecDoub_I &ssig, VecDoub_I &aa,
           ...
           TOL=1.e-4) : ndat(xx.size()), ma(aa.size()), x(xx), y(yy), sig(ssig),
